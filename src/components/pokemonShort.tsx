...
export default function PokemonShort({
  ...
  return (
    <div
      className="bg-white my-8 mx-3 h-28 rounded-lg flex flex-auto flex-col justify-center text-center items-center
          relative shadow-lg cursor-pointer hover:border border-gray-500 group"
    >
      <Image
